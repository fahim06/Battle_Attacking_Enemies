...
elixer = Item("Elixer", "elexer", "Fully restore HP/MP of one party member", 9999)
hielixer = Item("Mega-Elixer", "elexer", "Fully restores party's HP/MP", 9999)
...
print(bcolor.FAIL+bcolor.BOLD+"AN ENEMY ATTACTS!"+bcolor.ENDC)
while running:
    print("=========================================================================")
    ...
    for player in players:
        ...
        if index == 0:
            ...
            if spell.type == "white":
                ...
                print(bcolor.OKBLUE + "\n" + spell.name + " heal for", str(magic_dmg), "HP." + bcolor.ENDC)
            ...
            if item.type == "potion":
                ...
                print(bcolor.FAIL + "\n" + item.name + " deals", str(item.prop), "points of damage to" + enemies[enemy].name + bcolor.ENDC)

                if enemies[enemy].get_hp() == 0:
                    print(enemies[enemy].name.replace(" ", "") + " has died.")
                    del enemies[enemy]

    #Check ifbattle is over 
    defeated_enenies = 0
    defeated_players = 0
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == "white":
                ...
                print(bcolor.OKBLUE + "\n" + spell.name + " heal" + enemy.name + " for", str(magic_dmg), "HP." + bcolor.ENDC)
